...
本研究のテーマは「3D Gaussian Splatting を用いたインタラクティブなVRシステムの構築」であり、3D Gaussian Splatting (3DGS) とバーチャルリアリティ (VR) 領域を深く統合し、高効率かつ高忠実度なVRシーンの表現とレンダリング手法を探索することで、没入型インタラクション体験の発展を推進することを目的とします。
